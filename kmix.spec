...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kmix-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kmix-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kmix-19.12.3
cd %{_builddir}/kmix-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583450714
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmix-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/kmix/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kmix-19.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmix/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/kmix-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kmix/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/kmix-19.12.3/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kmix/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kmix
